        ...
        <div className="block">
            <div className="form">
                <form onSubmit={onSubmit}>
                    ...
                    <input autoComplete="new-password" name="password" className="login_box" placeholder="비밀번호" onChange={onChange} value={form.password} minLength="8"/>
                    {form.password.length > 0 && form.password.length < 8  && <div style={{color : 'red'}}>영어, 숫자를 포함한 8자 이상 입력해주세요.</div>}

                    <input autoComplete="new-password" name="password2" className="login_box" placeholder="비밀번호 확인" onChange={onChange} value={form.password2} minLength="8"/>
